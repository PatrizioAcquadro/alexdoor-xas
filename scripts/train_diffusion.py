...
def main() -> int:
    ...
    from alexdoor_xas.policies.common.data import PolicyDataError, checkpoint_provenance
    ...
    provenance = checkpoint_provenance(
        data, config_dict, source_git_commit=source_git_commit, policy="diffusion"
    )
