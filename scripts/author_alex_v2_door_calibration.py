...
def _episode_evidence(episode: Any, distances: list[float]) -> tuple[dict[str, Any], bool]:
    ...
    summary = {
        ...
        "environment_terminated": None if outcome is None else outcome.environment_terminated,
        "environment_truncated": None if outcome is None else outcome.environment_truncated,
