"""Self-contained Diffusion checkpoint v2 with legacy Phase 3 loading."""
...
LEGACY_CHECKPOINT_FORMAT = "alexdoor_xas.diffusion.v1"
...
def load_checkpoint(path: str | Path, map_location: str = "cpu") -> LoadedCheckpoint:
    ...
    model = DiffusionTransformer(obs_dim=obs_dim, action_dim=action_dim, cfg=model_cfg)
