...
def attach_visual_room(
    ...
    *,
    ...
    from pxr import Gf, Sdf, UsdGeom, UsdLux, UsdPhysics  # noqa: PLC0415
...
def _validate_alignment(
    ...
    *,
    ...
    position_error = (source.ExtractTranslation() - target.ExtractTranslation()).GetLength()
    if position_error > 1e-4:
        raise VisualRoomError(
            f"visual doorway alignment error is {position_error:.6f} m"
        )
